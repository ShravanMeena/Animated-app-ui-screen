...
const getImage = (i) => `https://source.unsplash.com/600x${400 + i}/`;
    ...
    <SafeAreaView>
      ...
      <Animated.ScrollView
        ...
        <View style={{marginVertical: 20}}>
          <Text style={{fontSize: 24, paddingVertical: 20, fontWeight: '700'}}>
            Featured{' '}
          </Text>
          {articleParagraphs.slice(0, 3).map((text, index) => {
            return (
              <View
                ...
                />
                <Text style={styles.paragraph}>{text.slice(0, 75)}...</Text>
              </View>
            );
          })}
        </View>
